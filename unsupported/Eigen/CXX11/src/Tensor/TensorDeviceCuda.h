...
#if defined(EIGEN_USE_GPU) && !defined(EIGEN_CXX23_TENSOR_TENSOR_DEVICE_CUDA_H)
#define EIGEN_CXX23_TENSOR_TENSOR_DEVICE_CUDA_H
...
#endif  // EIGEN_CXX23_TENSOR_TENSOR_DEVICE_CUDA_H
